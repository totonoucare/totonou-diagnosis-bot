    ...
    try {
      ...
      return {
        messages: [
          ...
          {
            type: 'text',
            text: `📅 東洋医学で本格ケア、まずは今週から試してみませんか？
あなたの体質に合わせた“ととのうガイド”をもとに、まずはできそうなことから1つだけで大丈夫。
小さな一歩が、あなたの中の「ととのうチカラ」を進化させ、着実に不調を解消するはずです🌱💪
...
（あなたの体調とセルフケア実施状況に基づき、AIが継続をフォローします）

AIが東洋パーソナルケアを手軽に提供できる時代。AIと一緒に「ととのうチカラ」を身につけていきませんか？

🧭 もし行き詰まりを感じたときは、
オンライン相談や治療院のご案内（メニューバー内）もございます。
あなたの「ととのうチカラ」をどこまでも全力サポートします！✊
