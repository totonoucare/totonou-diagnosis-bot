...
"体内の巡り方のクセ"や"体表面の経絡ライン(けいらく：皮膚や筋膜などの繋がり)のこわばりのクセ"
といった複数の要因が関係しています。
...
🟢 『${typeName}』の特徴`,
  ...
  parts.push({
    ...
    text:
      flowType === "巡りは良好"
        ? "まとめると、体質（根本）をベースに、経絡（内臓と関連する体表面）のこわばりが表れ、今の不調につながっている状態です。"
        : "まとめると、①体質（根本）をベースに、②巡り（体内の流れ）のクセや③経絡ラインのこわばりが表れ、今の不調につながっている状態です。",
  });
...
// ======================================
const introPriority = {
  breathing: "🧭 優先して取り組みたいケア。内側の圧や緊張を根本から整え、偏った巡りやこわばりを中心から立て直していく統括的なケアです。",
  stretch: "🧭 優先して取り組みたいケア。姿勢や動きの癖で負担を経絡ライン（皮膚・筋膜・内臓のつながり）をゆるめ、詰まった“巡りの通り道”をひらくケアです。",
  points: "🧭 優先して取り組みたいケア。姿勢や動きの癖でこわばりやすい経絡ライン（皮膚・筋膜・内臓のつながり）の要所ポイントから詰まりを解除するケアです。",
  lifestyle: "🧭 優先して取り組みたいケア。からだの土台を整える長期ケアです。体質そのものを改善していきます。",
};

const introSupport = {
  breathing: "💡 優先ケアを補完するサポートケア。内側から圧や緊張を整え、全身の張りや巡りをスムーズにする基礎ケアになります。",
  stretch: "💡 優先ケアを補完するサポートケア。姿勢や動きの癖でこわばりやすい経絡ラインをゆるめ、詰まった“巡りの通り道”をひらくケアです。",
  points: "💡 優先ケアを補完するサポートケア。こわばりやすい経絡ラインの要所ポイントから詰まりを解除するケアです。",
  lifestyle: "💡 からだの土台を整え、優先ケアの効果を維持する長期ケア。体質そのもののバランスを改善していきます。",
