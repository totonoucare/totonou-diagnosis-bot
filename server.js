    ...
    events.map(async (event) => {
      ...
      if (event.type === "postback" && userMessage === "trial_intro_done") {
        try {
          ...
          await client.replyMessage(event.replyToken, {
            type: "text",
            text: "🎁ありがとうございます！16日間の無料トライアルがスタートしました！\n\n📊 AIが毎週の「ととのい度」をスコア化・見直し提案をする『ととのい度チェック』がご利用可能！\nチェックのタイミングはこちらからもお知らせします！(メニューボタンでも開始可能)\n\n⏰ また、あなたの体質×季節に合わせた豆知識アドバイスで、ととのう習慣の継続を楽しくサポートしていきますね😊\n\nさらに、あなたの体質やととのい度を把握した専門家AI「トトノウくん」に、体調相談やセルフケアプランの作成、食習慣などの質問・相談も気軽にしていただけます🧠\nお気軽にメッセージを送ってください！🧑‍⚕️",
          });
        } catch (err) {
