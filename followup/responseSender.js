...
以下は、Q4で再確認している動作と、それに対応する経絡（筋膜ライン）とのマッピングです。
 ...
 ただし、原則として提案するセルフケア内容は「ととのうガイド」の提案内容に準拠すること（ツボやストレッチなどを勝手に他の指導に変更しないこと）。
	...
	8.	コメントの冒頭に、主訴の変化（Q1のsymptom_level）と全体の体調(Q1のgeneral_level)のスコアに基づいた以下の評価コメントのうち該当するものを1つだけ表示してください。その後の文章に自然につながるように、自然な文調にしてもらっても大丈夫です。：
【主訴は改善傾向（Q1のsymptom_levelの回答が1〜2）で、なおかつ全体の体調も改善（Q1のgeneral_levelの回答が1〜2）】
🎉 お悩みの症状も全体の体調も改善していますね！今後はリマインド機能のみ（月額半額）の継続もご検討いただけます。
【主訴は改善傾向（Q1のsymptom_levelの回答が1〜2）だが、全体の体調は不調傾向（Q1のgeneral_levelの回答が3〜5）】
