...
・1位：体質改善習慣　・2位：ストレッチ  ・3位：呼吸法　・4位：ツボ　・5位：漢方薬
	...
	4.	Q4の「動作テストの変化」は、初回診断時の動作テストの結果で判明した、最も伸展しづらく負荷が大きかった経絡ライン＝臓腑不調のサインの改善度合い（「5」＝最もツラい、「1」＝改善）を再確認するための設問です。
...
以下は、Q4で再確認している動作と、それに対応する経絡（筋膜ライン）とのマッピングです。
	...
	5.	原則としてアドバイスは「ととのうガイド」の5つのケア提案内容に準拠すること（ツボやストレッチなどを勝手に他の指導をしない）。
 必要に応じて、初回診断時の体質スコア・タイプ・臓腑の傾向・巡りの傾向なども参考にしてコメントに織り交ぜてください（簡潔でOKです）。
...
【主訴が改善（Q1の回答が1〜2）かつ全体も改善（Q2の回答が1〜2）】
🎉 お悩みの症状も全体の体調も改善していますね！今後はリマインド機能のみ（月額半額）の継続もご検討いただけます。

【主訴が改善（Q1の回答が1〜2）だが全体は不調（Q2の回答が3〜5）】
